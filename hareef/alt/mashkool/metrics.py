...
def error_rates(diacritizer, data_loader, num_batches):
    ...
    try:
        with TemporaryDirectory() as predictions_dir:
            error_rates = MashkoolModel.evaluate_with_error_rates(diacritizer, data_loader, num_batches=num_batches, predictions_dir=predictions_dir)
    except:
